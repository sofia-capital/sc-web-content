---
linkTitle: "Tools"
title: "Tools of a Fundamental Analyst"
slug: "tools-of-a-fundamental-analyst"
weight: 8
prev: /docs/Module 1/7 - Financial Instruments.md
next: /docs/Module 1/9 - Vocabulary.md
---
...
![](/images/M1/D8/ES-M1-D8-Tikr-Pagina-inicio.png)
...
![](/images/M1/D8/ES-M1-D8-Tikr-Dashboard.png)

As an example, let's search for the company Apple (Ticker: AAPL).

![](/images/M1/D8/ES-M1-D8-Tikr-Buscar-AAPL.png)
...
![](/images/M1/D8/ES-M1-D8-Tikr-AAPL-Informacion-financiera.png)
...
![](/images/M1/D8/ES-M1-D8-Tikr-AAPL-Estimacion-analistas.png)

{{< callout type="info" >}}
 As a fun fact, if you hover your cursor (mouse) over the estimate you will see the total number of analysts who have made it.
{{< /callout >}}
...
- [Files compatible with NotebookLM - Click me](https://support.google.com/notebooklm/answer/16215270?hl=en&co=GENIE.Platform%3DDesktop#:~:text=NotebookLM%20supports%20these%20source%20types,MP3%20and%20WAV%2C%20among%20others.&text=Images%3A,ico%2C%20jp2%2C%20png%2C%20webp)
...
![](/images/M1/D8/ES-M1-D8-NotebookLM-Pagina-Principal.png)

If you are not logged in with any Gmail account, it will ask you to register or create a new account. 

![](/images/M1/D8/ES-M1-D8-NotebookLM-Google-Inicio-de-sesion.png)
...
![](/images/M1/D8/ES-M1-D8-NotebookLM-Dashboard.png)

If you open the Alphabet folder using the link I gave you, you can see the following:

![](/images/M1/D8/ES-M1-D8-NotebookLM-Carpeta-Alphabet.png)

1. The Sources section: where the files you have shared with NotebookLM are located
2. The chat: where you can write the corresponding questions
3. Studio: the part I love and am most impressed with about NotebookLM, the audio summaries are great.
...
![](/images/M1/D8/ES-M1-D8-Koyfin-Dashboard.png)
...
![](/images/M1/D8/ES-M1-D8-TradingHours.png)
